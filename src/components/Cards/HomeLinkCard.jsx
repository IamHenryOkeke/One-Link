const HomeLinkCard = ({title, link}) => {
    return (
        <a className="bg-slate-700 cursor-pointer p-5 rounded-lg flex items-center justify-between w-[90%] md:w-[60%]" href={link} target="_blank" rel="noreferrer">
            <span className="no-underline hover:underline capitalize font-bold text-md md:text-lg">
                {title}
            </span>
