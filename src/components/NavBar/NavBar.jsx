        ...
        {(location.pathname === "/") ? (
          ...
          <div className='hidden md:flex gap-8 items-center'>
            <ul className='hidden md:flex gap-8'>
              <li className="font-bold transition-all ease-in-out delay-150 hover:text-[#53b941] hover:tracking-widest duration-300 cursor-pointer"><Link to="/home">Profile</Link> </li>
                  ...
                  <div className='flex flex-col items-center gap-8 text-3xl text-white'>
                    <ul className='flex flex-col items-center gap-8'>
                      <FadeIn delay="delay-[150ms]">
                        <li onClick={() => handleClick()} className="cursor-pointer"><Link to="/home">Profile</Link></li>
                      </FadeIn>
